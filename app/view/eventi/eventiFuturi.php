...
<nav class="navbar ">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" id="current" href="eventiFuturi">Eventi</a>
                  </li>
                  <li class="nav-item">
        ...
        <!-- fine navbar -->
          ...
          <div id="center">
            <h1 class="text-center"><b>Eventi</b></h1>
            <div class="d-flex justify-content-end">
              <a href="eventiPassati" id="bttn" class="btn btn-outline-light btn-rounded">Eventi Passati</a>
            </div>
            <br>
            <!-- card evento -->
            <?php
                if ( count($eventi) > 0){
                    foreach ($eventi as $evento) {
                        ...
                        echo '<a href="dettagliEvento/'.$evento['idVisita'].'" class="btn btn-light me-4">Dettagli</a>';  
                        echo '<a href="acquistaBiglietto/'.$evento['idVisita'].'" class="btn btn-light ms-4">Prenota</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
