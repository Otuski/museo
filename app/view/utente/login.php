    ...
    <div id="container" class="container text-center"> 
      <div class="row">
        ...
        <div id="content" class="col-10">
          ...
          <div id="center">
            <h1 class="text-center"><b>Accedi</b></h1>
            ...
            <form action="elaboraLogin" method="POST">
              ...
              <div class="card" style="width: 100%;">
                <div class="card-body align-items-center text-center">
                  <div class="row d-flex align-items-center">
                    ...
                    <div class="col">
                      <input class="ms-5" type="text" id="field" name="username" placeholder="username"><br>
                    </div>
              ...
              <br>
              <input class="btn btn-light btn-lg" type="submit" value="Entra">
            </form>
            <!-- fine form -->

            <br>
            <a href="signin" id="link" class="text-center p-3">Non sei ancora registrato? Fallo qui.</a>
          </div><!-- fine #center -->
